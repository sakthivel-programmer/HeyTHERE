            ...
            <div className={Styles.coversationDiv}>
                ...
                <div className={Styles.footer}>
                    ...
                    <form onSubmit={handleSubmit}>
                        <input class={Styles.messagebox} onChange={(e)=>setMessage(e.target.value)} type="text" ref={messageField} placeholder="Type message..." aria-label="Search"/>
                        <button class={Styles.messagebtn} type="submit">Send</button>
                    </form>
